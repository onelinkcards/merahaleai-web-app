...
export default function FilterSidebar({ filters, setFilters, onReset, isMobile }: FilterSidebarProps) {
    ...
    <aside
      className={
        isMobile
          ...
          : "sticky top-[100px] hidden h-[calc(100vh-120px)] w-[320px] flex-shrink-0 flex-col self-start overflow-y-auto overflow-x-hidden rounded-2xl border border-[#E5E0D8] bg-[#FFFFFF] p-6 scrollbar-hide md:flex"
      }
    >
      {/* Header */}
      <div className="mb-2 flex items-center justify-between pb-4 border-b border-[#E5E0D8]">
        <div className="flex items-center gap-2">
        ...
        {(totalActive > 0 || filters.guests > 0 || filters.eventType || filters.cuisines.length > 0) && (
          <button
                ...
                <button
                  ...
                  className={
                    ...
                    (active
                      ...
                      : "border-[#E8D5B7] bg-[#FFFAF5] text-[#8B7355] hover:border-[#804226] hover:text-[#804226]")
                  }
                >
                  {item.val > 0 ? (
            ...
            <button
              ...
              className={
                ...
                (filters.foodPref === "veg"
                  ...
                  : "border-[#E8D5B7] bg-[#FFFAF5] text-[#1E1E1E] hover:border-green-500")
              }
            >
              <span
                className={
            ...
            <button
              ...
              className={
                ...
                (filters.foodPref === "nonveg"
                  ...
                  : "border-[#E8D5B7] bg-[#FFFAF5] text-[#1E1E1E] hover:border-red-500")
              }
            >
              <span
                className={
              ...
              return (
                <button
                  ...
                  className={
                    ...
                    (checked ? "border-[#804226] bg-[#FFF3E8]" : "border-[#E8D5B7] hover:border-[#804226]")
                  }
                >
                  <span
                    className={
              ...
              return (
                <button
                  ...
                  className={
                    ...
                    (active
                      ? "border-[#804226] bg-[#804226] text-[#FFFFFF]"
                      : "border-[#E8D5B7] bg-[#FFFAF5] text-[#804226] hover:border-[#804226]")
                  }
                >
                  {item}
                </button>
              ...
              return (
                <button
                  ...
                  className={
                    ...
                    (checked ? "bg-[#FFF3E8]" : "hover:bg-[#FFFAF5]")
                  }
                >
                  <span
                    className={
      ...
      {/* --- CATERER TYPE --- */}
      <div className="rounded-2xl border border-[#E8D5B7] bg-[#FFFFFF] p-4 mb-6">
        <div className="mb-3">
